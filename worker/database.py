...
# ─────────────────────────────────────────────────────────────────────────────
# Platform → table-prefix. Adding a new platform = one line here + a migration
# that creates {prefix}_campaign_videos / {prefix}_influencer_profiles /
# {prefix}_comments mirroring the IG/TikTok shape.
